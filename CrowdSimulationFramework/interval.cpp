...
Interval::Interval() :m_isEmpty(true),m_start(0),m_end(0)
{
}
...
Interval::Interval(const Interval& interval) :m_start(interval.m_start),m_end(interval.m_end),m_isEmpty(interval.m_isEmpty)
{
}
